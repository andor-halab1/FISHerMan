...
if length(varargin) >= 1
    ...
    params = struct('species','Mouse','verbose',1,'GbMem',16,'maxFragment',1E3,...
        'crosshybeT',72,'secstructT',72.0,'minTm',70,'maxTm',90,...
        'minPercentGC',40.0,'maxPercentGC',65.0,'probeLength',30,...
...
copyfile([params.species '.target1kb.fas'], [params.oligoArrayPath params.species '.target1kb.fas']);
