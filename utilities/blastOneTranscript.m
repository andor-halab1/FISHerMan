function seqDelete...
    =blastOneTranscript(OTAdapterHeader,OTAdapterSequence,probeHeader,probeSequenceCore,params)
...
filePathList = blastFileSplit(OTHeader, OTSequenceCore, length(OTHeader), params);
