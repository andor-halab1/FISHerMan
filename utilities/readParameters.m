...
ST1=xmlParse(oligos, 'oligos', 'ST1');
ST2=xmlParse(oligos, 'oligos', 'ST2');
ST3=xmlParse(oligos, 'oligos', 'ST3');
...
params.oligos = struct('species',species,...
    ...
    'specialTranscripts',...
    struct('specialTranscripts',{char(ST1.getFirstChild.getData),...
    char(ST2.getFirstChild.getData),...
    char(ST3.getFirstChild.getData)}));
